      ...
      [
        {
          ...
          value: function componentMount() {
            ...
            _get(
              ...
              "componentMount",
              this
            ).call(this) // load library depending on driver
            ...
            switch (this.props.driver) {
              case "fonticon":
                return Promise.resolve(
                  '<i class="'
                    .concat(this.props.iconsPrefix)
                    .concat(this.props.icon, '" aria-hidden></i>')
                )

              case "img":
                return Promise.resolve(
                  '<img src="'
                    .concat(this.props.iconsPath, "/")
                    .concat(this.props.icon, '.svg" alt="')
                    .concat(this.props.title, '">')
                )

              case "fontawesome":
                return Promise.resolve(
                  '<i class="fa fa-'.concat(
                    this.props.icon,
                    '" aria-hidden></i>'
                  )
                )
              ...
              case "material":
                return Promise.resolve(
                  '<i class="material-icons" aria-hidden>'.concat(
                    this.props.icon,
                    "</i>"
                  )
                )
              ...
              case "foundation":
                return Promise.resolve(
                  '<i class="fi-'.concat(this.props.icon, '" aria-hidden></i>')
                )
        ...
        },
        {
          ...
          value: function _injectLibraryDependingOnDriver() {
            switch (this.props.driver) {
              case "fontawesome": {
                var fontawesomeElm = document.querySelector(
                  "link#s-fontawesome"
                )
          ...
          value: function _loadSvgIcon() {
            ...
            return new Promise(function(resolve) {
              _axios.default
                .get(
                  ""
                    .concat(_this2.props.iconsPath, "/")
                    .concat(_this2.props.icon, ".svg")
                )
                .then(function(response) {
                  var domParser = new DOMParser()
                  var docElm = domParser.parseFromString(
                    response.data,
                    "text/html"
                  )
